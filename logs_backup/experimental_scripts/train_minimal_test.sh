...
echo "=== Minimal Test: TP=16, batch=4, n=1, steps=1 ==="
...
python3 -m rllm.trainer.verl.train_agent_ppo \
    ...
    trainer.project_name=deepswe-minimal \
    ...
    trainer.default_local_dir=/tmp/test_checkpoint \
    rllm.env.name=swe \
    ...
    2>&1 | tee ~/work/logs/minimal_test.log
