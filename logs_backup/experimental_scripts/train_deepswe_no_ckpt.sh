...
# DeepSWE Full Training - TP=16 (rollout), Ulysses=8 (FSDP), batch=4, n=8
# Option B: Cross-node rollout + single-node FSDP for faster PPO update
...
echo "Config: TP=16 (rollout), Ulysses=8 (FSDP), batch=4, n=8"
...
python3 -m rllm.trainer.verl.train_agent_ppo \
    ...
    2>&1 | tee ~/work/logs/deepswe_no_ckpt.log
